...
for iii in range(0, len(countFreezes)):
    ...
    model_path_final = 'my_model_' + str(countFreeze) + '_' + str(img_width) + '_final.h5'
    model_path_best = 'my_model_' + str(countFreeze) + '_' + str(img_width) + '_best.h5'
    ...
    # call back
    checkpointer = ModelCheckpoint(filepath=model_path_best, save_best_only=True)
    ...
    model.fit_generator(
        ...
        callbacks = [checkpointer, reduceLRCallBack, earlyStopCallBack],
        verbose = 2,
