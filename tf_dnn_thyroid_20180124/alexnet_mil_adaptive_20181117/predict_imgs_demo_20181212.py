...
##
val_file = 'D:\\project\\wjx\\EndMaster_Demo\\nodule_path_init.txt'
...
max_count = Counts[0] * count_good; min_count = Counts[1] * count_good #5334,3556
...
with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
    ...
    if 2 > 1:
        ...
        rootdir='D:\\project\\wjx\\nodule_path.txt'
        location_file_result='D:\\project\\wjx\\nodule_path_classification.txt'
        print("{} Start Prediction ...".format(datetime.now()))
        print('Update prediction data ...')
