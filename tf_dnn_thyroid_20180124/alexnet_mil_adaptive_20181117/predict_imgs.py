...
Counts = Counts11[5] ## 表示数量下降的最高值和最低值

##
##val_file = 'I:/thyroid-all-gray-20180124/validationData/nodules/validationData-all.txt'
##location_file_result = 'I:/thyroid-all-gray-20180124/validationData/nodules/validationData-all-new'\
##                       + '-' + str(Counts[0]) + '-' + str(Counts[1]) + '.txt'

val_file = 'I:/thyroid-all-gray-20180124/testData/nodules/testData-all.txt'
#location_file_result = 'I:/thyroid-all-gray-20180124/testData/nodules/testData' \
#                      + '-' + str(Counts[0]) + '-' + str(Counts[1]) + '_20200304_2.txt'
location_file_result = 'D:/project/wjx/wildcat_dataset/DrawROC/testData'+ '-' + str(Counts[0]) + '-' + str(Counts[1]) +'_iccc-'+str(5)+ '_20200305_2.txt'
##
##val_file = 'I:/thyroid-all-gray-20180124/openData-finetune-classification-60-100/validation/nodules-1/all-nodules.txt'
##location_file_result = 'I:/thyroid-all-gray-20180124/testData/nodules/testData-opendata' \
##                       + '-' + str(Counts[0]) + '-' + str(Counts[1]) + '.txt'
##
if os.path.exists(location_file_result):
    print(location_file_result + ' already exist!!!')
    exit(0)
...
#model_save_dir = 'I:/gyt-data/model/finetune_alexnet_bishe_20200303_wp_1_te_1.1'
max_count = Counts[0] * count_good; min_count = Counts[1] * count_good
#max_count = 1500; min_count = 1500
...
model_save_dir_iccc = os.path.join(model_save_dir_ccc, 'iccc-' + str(4))
