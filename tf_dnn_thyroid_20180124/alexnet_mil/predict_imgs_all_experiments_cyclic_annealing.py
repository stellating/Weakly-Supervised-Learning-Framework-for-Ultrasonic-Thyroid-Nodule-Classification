...
Counts11 = [[3, 3]] ## 表示数量下降的最高值和最低值
Counts = Counts11[0] ## 表示数量下降的最高值和最低值

##
#val_file = 'I:/thyroid-all-gray-20180124/validationData/nodules/validationData-all.txt'
#location_file_result = 'I:/thyroid-all-gray-20180124/validationData/nodules/5validationData-all'\
...
# val_file = 'I:/thyroid-all-gray-20180124/validationData/nodules/validationData-all.txt'
location_file_result = 'I:/thyroid-all-gray-20180124/testData/nodules/testData-em' \
                       + '-' + str(Counts[0]) + '-' + str(Counts[1]) + '-' + str(T) + '.txt'
