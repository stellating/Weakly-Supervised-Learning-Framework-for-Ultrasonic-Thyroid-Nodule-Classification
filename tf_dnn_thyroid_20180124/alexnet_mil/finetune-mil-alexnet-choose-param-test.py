...
for iWeight in range(0, len(weightPositives)):
    ...
    for iProp in range(0, len(propPositives)):
        ...
        filewriter_path = 'I:/thyroid-all-gray-20180124/trainData/nodules/train_process/finetune_alexnet/tensorboard'
        checkpoint_path = 'I:/thyroid-all-gray-20180124/trainData/nodules/train_process/finetune_alexnet/checkpoints'
        checkpoint_path_fc = 'I:/thyroid-all-gray-20171213/trainData/ChoseForBenignManign-Alex-227/modelPath/finetune_alexnet_fc/checkpoints'
            ...
            for epoch in range(num_epochs):
                ...
                for step in range(val_bad_bag_batches_per_epoch):
                    ...
                    [p_value] = sess.run([p_pred],
                                         feed_dict={x: img_batch, y: label_batch, y_weight: w, keep_prob: 1.0})
                    # print(p_value)
