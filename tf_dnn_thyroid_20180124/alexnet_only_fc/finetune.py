...
filewriter_path = 'I:/thyroid-all-gray-20171213/trainData/ChoseForBenignManign-Alex-227/modelPath/finetune_alexnet/tensorboard'
checkpoint_path = 'I:/thyroid-all-gray-20171213/trainData/ChoseForBenignManign-Alex-227/modelPath/finetune_alexnet/checkpoints'
...
# Initialize model
model = AlexNet(x, keep_prob, num_classes, reinitialization_layers, weights_path = 'bvlc_alexnet.npy')
